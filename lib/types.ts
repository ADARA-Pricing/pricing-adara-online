...
export type MercadoLibreOrderItem = {
  ...
  real_total_net_profit?: number | null;
  real_margin_on_net_sale?: number | null;
...
export type TiendanubeWebBanner = {
  id?: string;
  placement?: "main_carousel" | "promo_strip" | "featured_product" | string | null;
  position: number;
  title: string;
