...
function normalizedProfitability({
  ...
  return {
    ...
    normalized_net_sale_price: actualResult.valid ? actualNetSalePrice : null,
    ...
    normalized_margin_on_net_sale: actualResult.valid ? Number(actualResult.marginOnNetSale || 0) : null,
